...
["짝수" if x % 2 == 0 else "홀수" for x in range(1, 11)]
print(result)
...
# x = 0 1 2
# y = 0 1 2
# x * y 로 이루어진 리스트 [0, 0, 0, 0, 1, 2, 0, 2, 4]
...
result = [sum([scores[j][i] for j in range(len(scores))]) / len(scores) for i in range(len(scores[0]))]
