...
def introduce(name, hometown, mbti = "ISTJ"):
    return f"저는 {name}이고, {hometown}에 살고, {mbti}입니다."

print(introduce("뽀로로", "일산", "ENFP"))
print(introduce(hometown = "화성", mbti = "ADHD", name = "황황황"))
print(introduce(hometown = "파주", name = "보보보"))
...
introduce2(name="크롱", age=4, kind="공룡", birthday="몰라")
...
def pocket_money(remain, *args, **kwargs):
    tot = remain + sum(args) + sum(kwargs.values())
    return tot

print(pocket_money(500, 100, 200, 아빠한테_받은_돈=10000, 엄마한테_받은_돈=5000))
print(pocket_money(500, 100, 200, 300, 아빠한테_받은_돈=10000, 엄마한테_받은_돈=5000, 삼촌한테_받은_돈=100000))
